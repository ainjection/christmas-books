/* Christmas Shelf visit counter. Same Supabase table as The Gentle Bookshop (book = 'halloween-shelf').
...
(function () {
  ...
  try {
    ...
    if (src) { try { sessionStorage.setItem('cs_src', src); } catch (e) {} }
    else { try { src = sessionStorage.getItem('cs_src'); } catch (e) {} }
